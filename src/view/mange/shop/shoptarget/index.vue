...
<script>
import { shoptargetLayout, getShopTargetList } from "@/api/mange/shop/shoptarget";
...
export default {
  ...
  methods: {
    ...
    getList() {
      return getShopTargetList(Object.assign(this.pageData, this.formData))
        .then((res) => {
